...
import MBBFinancialChart from '../chart/MBB-chart'; // Adjust the path if needed
...
const MBBTable = () => {
  ...
  return (
    <>
      <div className='title'>Baó cáo tài chính {symbol}</div>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
        <h1 className='title'>{symbol} Financial Chart</h1>
        <MBBFinancialChart symbol={symbol} />
      </div>
    </>
  );
};
